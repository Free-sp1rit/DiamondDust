...
The project is in the pre-MVP governance and architecture setup stage.

Product implementation code should not begin until the startup documents are approved and the relevant review gate has passed.

Governance, planning, review, testing setup, repository structure, and agent operating rules may be refined during this stage.

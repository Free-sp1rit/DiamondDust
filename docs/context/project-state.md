...
Post-Gate 7 formal vault conflict checks complete with follow-up.
...
- add formal vault apply/revert only after rollback/write-failure tests and explicit apply boundaries exist

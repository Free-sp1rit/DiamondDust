...
- Next likely stage: product-owner review of the pre-live-smoke OpenAI adapter, then separate decisions for default model, API key value reading, prompt/source/schema externalization, cost limit, real network call, and one manual live smoke.
